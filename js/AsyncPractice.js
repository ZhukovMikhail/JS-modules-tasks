// const BASE_URL = 'https://61222aa7f5849d0017fb440d.mockapi.io/api/v1';

// const resf = {
//   inputComments: document.querySelector('#input-name'),
...
//   resf.commentsList.innerHTML = createTemplate(data);
//   console.log(data);
//   return data;
// }
// fetchComments();
...
async function onDeleteComment(e) {
  ...
  await fetch(
    `https://611cda5e7d273a0017e2f492.mockapi.io/api/v1/comments/${e.target.id}`,
    {
      method: 'DELETE',
    },
  );
...
async function sendData(e) {
  ...
  const resp = await fetch(
    'https://611cda5e7d273a0017e2f492.mockapi.io/api/v1/comments',
    {
      method: 'POST',
      body: JSON.stringify({
        ...data,
